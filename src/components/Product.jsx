          ...
          <div className="items-end justify-between sm:flex">
            <div className="max-w-xl">
              <h2 className="text-3xl font-bold tracking-tight sm:text-5xl">
                Experience the Excellence of Our Products
              </h2>
            ...
            <a
              href="#"
              className="mt-8 inline-flex shrink-0 items-center gap-2 rounded-full border border-blue-400 px-5 py-3 font-medium text-blue-400 hover:bg-blue-400 duration-[0.4s] hover:text-white sm:mt-0 lg:mt-8"
            >
              View all Products
              <svg
            ...
            <blockquote className="flex h-full flex-col justify-between bg-white p-12">
              <div>
                <div className="mb-4">
                  ...
                  <h3 className="text-xl  text-blue-400 sm:text-2xl">
                    Lorem ipsum dolor sit amet.
                  </h3>
                </div>
                <footer className=" text-xl mb-5 font-semibold text-gray-500">
                  25 $
                </footer>
